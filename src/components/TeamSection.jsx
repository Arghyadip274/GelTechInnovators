...
function TeamSection() {
  const teamMembers = [
    { name: "Arghadeep Das", role: "Leader and CAD", bio: "Leader with a passion for innovation and luxury design.", image: "public/0a5c2352-a672-4dcf-be3d-4e0e56c656c6.jpeg" },
    { name: "Arghyadip Mondal", role: "Web team & CFD", bio: "Expert engineer with a focus on perfection and performance.", image: "public/arghyadip.jpeg" },
    { name: "Ishaan Sharma", role: "Documentation & CFD", bio: "Brings creative vision to life with elegance and style.", image: "public/d0b88ac3-02da-4318-a2ff-4a806b79eae1.jpeg" },
